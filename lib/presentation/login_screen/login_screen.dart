import 'controller/login_controller.dart';import 'package:flutter/material.dart';import 'package:taternak_v12/core/app_export.dart';import 'package:taternak_v12/core/utils/validation_functions.dart';import 'package:taternak_v12/widgets/custom_elevated_button.dart';import 'package:taternak_v12/widgets/custom_text_form_field.dart';import 'package:taternak_v12/domain/googleauth/google_auth_helper.dart';
// ignore_for_file: must_be_immutable
class LoginScreen extends GetWidget<LoginController> {LoginScreen({Key? key}) : super(key: key);

GlobalKey<FormState> _formKey = GlobalKey<FormState>();

@override Widget build(BuildContext context) { mediaQueryData = MediaQuery.of(context); return SafeArea(child: Scaffold(resizeToAvoidBottomInset: false, body: Form(key: _formKey, child: SizedBox(width: double.maxFinite, child: SingleChildScrollView(child: Column(children: [_buildAtas(), SizedBox(height: 19.v), CustomImageView(imagePath: ImageConstant.imgImage20126x147, height: 126.v, width: 147.h), SizedBox(height: 27.v), Align(alignment: Alignment.centerLeft, child: Padding(padding: EdgeInsets.only(left: 26.h), child: Text("lbl_login".tr, style: theme.textTheme.headlineSmall))), SizedBox(height: 19.v), _buildEmail(), SizedBox(height: 19.v), _buildPassword(), SizedBox(height: 14.v), Align(alignment: Alignment.centerRight, child: Padding(padding: EdgeInsets.only(right: 16.h), child: Text("lbl_lupa_password".tr, style: CustomTextStyles.titleLargeGreen300))), SizedBox(height: 30.v), _buildMasuk(), SizedBox(height: 45.v), _buildLineTwentyOne(), SizedBox(height: 29.v), _buildGoogle(), SizedBox(height: 51.v), RichText(text: TextSpan(children: [TextSpan(text: "msg_kamu_belum_punya2".tr, style: CustomTextStyles.bodyMediumOnPrimaryContainer_1), TextSpan(text: "lbl_daftar".tr, style: CustomTextStyles.bodyMediumGreen300)]), textAlign: TextAlign.left), SizedBox(height: 51.v)])))))); } 
/// Section Widget
...
/// Section Widget
Widget _buildLineTwentyOne() { return Padding(padding: EdgeInsets.symmetric(horizontal: 16.h), child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, children: [Padding(padding: EdgeInsets.only(top: 8.v, bottom: 11.v), child: SizedBox(width: 105.h, child: Divider(color: theme.colorScheme.onPrimaryContainer))), Text("msg_atau_masuk_dengan".tr, style: CustomTextStyles.bodyMediumOnPrimaryContainer), Padding(padding: EdgeInsets.only(top: 8.v, bottom: 11.v), child: SizedBox(width: 105.h, child: Divider(color: theme.colorScheme.onPrimaryContainer)))])); } 
/// Section Widget
