...
import 'package:taternak_v12/widgets/custom_radio_button.dart';
...
class CheckoutOneScreen extends GetWidget<CheckoutOneController> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          "msg_sarah_rosiana".tr,
                          style: theme.textTheme.bodySmall,
                        ),
                      ),
                      SizedBox(height: 3.v),
                      _buildJlWonokromoPsr(),
                      SizedBox(height: 16.v),
                      Padding(
                        padding: EdgeInsets.only(left: 14.h),
                        child: Text(
                          "msg_jadwal_pengiriman_pengambilan".tr,
                          style: theme.textTheme.bodyMedium,
                        ),
                      ),
                      SizedBox(height: 6.v),
            ...
            child: Column(
              children: [
                _buildRpCounter(
                  ...
                  peternakSpiKita: "lbl_400_700_kg".tr,
                ),
                SizedBox(height: 5.v),
                _buildRpCounter(
                  rpCounter: "lbl_rp_18_000_000".tr,
                  peternakSpiKita: "msg_peternak_spi_kita".tr,
                ),
              ],
            ),
          ),
  ...
  /// Section Widget
  Widget _buildDiantar() {
    return Obx(
      () => Padding(
        padding: EdgeInsets.only(left: 28.h),
        child: CustomRadioButton(
          text: "lbl_diantar".tr,
          value: "lbl_diantar".tr,
                ...
                children: [
                  Expanded(
                    child: CustomOutlinedButton(
                      ...
                      buttonStyle:
                          CustomButtonStyles.outlineOnErrorContainerTL20,
                      buttonTextStyle:
  ...
  Widget _buildRpCounter({
    ...
    required String peternakSpiKita,
  }) {
    return SizedBox(
      width: 279.h,
      child: Row(
