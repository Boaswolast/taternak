import '../komunitas_screen/widgets/komunitas_item_widget.dart';import 'controller/komunitas_controller.dart';import 'models/komunitas_item_model.dart';import 'package:flutter/material.dart';import 'package:taternak_v12/core/app_export.dart';import 'package:taternak_v12/presentation/cari_page/cari_page.dart';import 'package:taternak_v12/widgets/app_bar/appbar_leading_image.dart';import 'package:taternak_v12/widgets/app_bar/appbar_subtitle.dart';import 'package:taternak_v12/widgets/app_bar/custom_app_bar.dart';import 'package:taternak_v12/widgets/custom_bottom_bar.dart';class KomunitasScreen extends GetWidget<KomunitasController> {const KomunitasScreen({Key? key}) : super(key: key);
...
/// Section Widget
PreferredSizeWidget _buildAppBar() { return CustomAppBar(height: 53.v, leadingWidth: 49.h, leading: AppbarLeadingImage(imagePath: ImageConstant.imgRewind, margin: EdgeInsets.only(left: 17.h, bottom: 29.v)), title: AppbarSubtitle(text: "lbl_komunitas".tr, margin: EdgeInsets.only(left: 11.h, top: 1.v, bottom: 27.v)), styleType: Style.bgFill); } 
/// Section Widget
