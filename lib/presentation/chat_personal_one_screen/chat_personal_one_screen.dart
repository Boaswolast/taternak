...
class ChatPersonalOneScreen extends GetWidget<ChatPersonalOneController> {
  const ChatPersonalOneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  Widget _buildChatPersonalOne() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          CustomImageView(
            imagePath: ImageConstant.imgFrame117,
            height: 75.v,
            width: 269.h,
          ),
          CustomImageView(
